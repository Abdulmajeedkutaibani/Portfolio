  ...
  return (
    ...
    >
      <motion.div
        ...
        className='circle-orange w-20 h-20 bg-gradient-to-tl from-blue-300 to-pink-600 rounded-full absolute right-16 top-6 p-1.5'
      >
      ...
      <div className='container mx-auto h-screen flex  px-10  lg:flex-row flex-col-reverse items-center justify-end lg:justify-start'>
        <div className='dark:bg-gray-500 bg-lightBlack dark:bg-opacity-20 bg-opacity-20 rounded-2xl p-6 bg-bl w-full lg:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start lg:text-left  md:mb-0 items-center text-center z-20'>
          ...
          <div className='primary-sub mb-8'>
            <div className='primary-sub__word'>
              <div className='primary-sub__top dark:text-green-400 text-purple-500'>
                I'm
              </div>
